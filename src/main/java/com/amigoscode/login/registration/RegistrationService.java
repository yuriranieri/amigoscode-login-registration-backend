...
import static com.amigoscode.login.appuser.AppUserRole.USER;

import com.amigoscode.login.appuser.AppUser;
import com.amigoscode.login.appuser.AppUserService;
import com.amigoscode.login.email.EmailSender;
...
public class RegistrationService {
  ...
  public String register(RegistrationRequest request) {
    ...
    String token = userService.signUpUser(getAppUser(request));
  ...
  public String confirmToken(String token) {
    ...
    validateTokenExpirationDate(confirmationToken);
  ...
  private AppUser getAppUser(RegistrationRequest request) {
  ...
  private void validateTokenExpirationDate(ConfirmationToken confirmationToken) {
